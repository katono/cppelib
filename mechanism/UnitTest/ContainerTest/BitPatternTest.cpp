...
{
	BitPattern<uint32_t> b(0x12345678);
...
{
	BitPattern<uint32_t> a(0x12345678);
	BitPattern<uint32_t> b(a);
	LONGS_EQUAL(0x12345678, b.data());
}
...
{
	BitPattern<uint32_t> a(0xAAAAAAAA);
	BitPattern<uint32_t> b(0x82824141);
	b &= a;
...
{
	BitPattern<uint32_t> a(0x3);
	BitPattern<uint32_t> b(0x2);
	(b &= a).set(0);
...
{
	BitPattern<uint32_t> a(0x12345678);
	BitPattern<uint32_t> b(0x12345679);
	bool f = (a == b);
	CHECK_FALSE(f);
}
...
{
	BitPattern<uint32_t> a(0xFFFFFFFF);
	CHECK(a.all());
}

TEST(BitPatternTest, all_false)
{
	BitPattern<uint32_t> a(0xFFFFFFFE);
	CHECK_FALSE(a.all());
}
